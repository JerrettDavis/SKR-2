...
#define STRING_CONFIG_H_AUTHOR "(Jerrett Davis, SKR-2)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 58.12
  #define DEFAULT_bedKi 5.38
  #define DEFAULT_bedKd 418.45
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 142.93 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, -.40 }
...
#define XY_PROBE_FEEDRATE (215*60)
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 63       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
